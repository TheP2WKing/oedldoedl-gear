...
public class BlockTrollTNT extends BlockTNT {
	...
	public BlockTrollTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
		super();
		this.modid = modid;
		this.name = name;
	...
	public void onBlockDestroyedByExplosion(World worldIn, BlockPos pos, Explosion explosionIn) {
		if (!worldIn.isRemote) {
			EntityTrollTNTPrimed entitytntprimed = new EntityTrollTNTPrimed(worldIn,
