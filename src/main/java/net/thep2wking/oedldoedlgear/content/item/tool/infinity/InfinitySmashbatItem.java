...
public class InfinitySmashbatItem extends ModSmashbatItemBase
{
	public InfinitySmashbatItem(IItemTier itemTier, float attackDamage, float attackSpeed, double horizontalMotion, double verticalMotion, HitSound hitSound, Set<Block> effectiveBlocks, Rarity rarity, 
