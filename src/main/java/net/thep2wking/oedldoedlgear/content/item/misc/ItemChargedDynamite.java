...
public class ItemChargedDynamite extends ModItemBase {
	public ItemChargedDynamite(String modid, String name, CreativeTabs tab, EnumRarity rarity, boolean hasEffect,
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
		...
		if (!worldIn.isRemote) {
			EntityChargedDynamite entity = new EntityChargedDynamite(worldIn, playerIn);
