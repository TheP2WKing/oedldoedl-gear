...
public class UnstableShieldItem extends ModShieldItemBase
{
	public UnstableShieldItem(IItemTier itemTier, Item repairItem, Rarity rarity, boolean hasEffect, boolean fireImmunity, int tooltipLines, int annotationLines, Properties properties) 
	{
	...
	{
		return stack.getItem() instanceof UnstableShieldItem;
	}
