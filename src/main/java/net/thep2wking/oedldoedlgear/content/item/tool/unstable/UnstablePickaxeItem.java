...
public class UnstablePickaxeItem extends ModPickaxeItemBase
{
	public UnstablePickaxeItem(IItemTier itemTier, int attackDamage, float attackSpeed, Rarity rarity, boolean hasEffect, boolean fireImmunity, int tooltipLines, int annotationLines, Properties properties) 
	{
	...
	{
		return stack.getItem() instanceof UnstablePickaxeItem;
	}
