...
public class TravellersBootsItem extends ModArmorItemBase
{
    public TravellersBootsItem(IArmorMaterial materialIn, EquipmentSlotType slot, Rarity rarity, boolean hasEffect, boolean fireImmunity, int tooltipLines, int annotationLines, Properties properties) 
    {
	...
	public void onArmorTick(ItemStack stack, World world, PlayerEntity player) 
	{
    	...
    	if (player.inventory.armorInventory.get(0).getItem().equals(ModItems.TRAVELLERS_BOOTS.get()))
    	{
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) 
    {
		...
		if (ModTooltips.showEffectTip())
		{
			...
			ModTooltips.addPotionEffect(tooltip, Effects.SPEED.getName(), false, 1, 20);
