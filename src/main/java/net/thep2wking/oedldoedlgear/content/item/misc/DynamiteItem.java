...
public class DynamiteItem extends ModItemBase
{
	public DynamiteItem(Rarity rarity, boolean hasEffect, boolean fireImmunity, int tooltipLines, int annotationLines, Properties properties) 
	{
