...
public class TravellersDiamondBootsItem extends ModArmorItemBase
{
	public TravellersDiamondBootsItem(IArmorMaterial materialIn, EquipmentSlotType slot, Rarity rarity, boolean hasEffect, boolean fireImmunity, int tooltipLines, int annotationLines, Properties properties) 
    {
    ...
    {
    	if (player.inventory.armorInventory.get(0).getItem().equals(ModItems.TRAVELLERS_DIAMOND_BOOTS.get()))
    	{
