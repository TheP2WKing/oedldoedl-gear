...
public class UnstablePaxelItem extends ModPaxelItemBase
{
	public UnstablePaxelItem(IItemTier itemTier, float attackDamage, float attackSpeed, Set<Block> effectiveBlocks, Rarity rarity, 
	...
	{
		return stack.getItem() instanceof UnstablePaxelItem;
	}
