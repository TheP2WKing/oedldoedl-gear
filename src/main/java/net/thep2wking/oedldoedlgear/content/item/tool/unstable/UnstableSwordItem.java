...
public class UnstableSwordItem extends ModSwordItemBase
{
	public UnstableSwordItem(IItemTier itemTier, int attackDamage, float attackSpeed, Rarity rarity, boolean hasEffect, boolean fireImmunity, int tooltipLines, int annotationLines, Properties properties) 
	{
	...
	{
		return stack.getItem() instanceof UnstableSwordItem;
	}
