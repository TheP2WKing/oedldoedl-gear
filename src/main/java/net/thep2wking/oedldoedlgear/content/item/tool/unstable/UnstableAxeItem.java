...
public class UnstableAxeItem extends ModAxeItemBase
{
	public UnstableAxeItem(IItemTier itemTier, float attackDamage, float attackSpeed, Rarity rarity, boolean hasEffect, boolean fireImmunity, int tooltipLines, int annotationLines, Properties properties) 
	{
	...
	{
		return stack.getItem() instanceof UnstableAxeItem;
	}
