...
public class ItemRockySnowball extends ModItemBase {
	public ItemRockySnowball(String modid, String name, CreativeTabs tab, EnumRarity rarity, boolean hasEffect,
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
		...
		if (!worldIn.isRemote) {
			EntityRockySnowball entity = new EntityRockySnowball(worldIn, playerIn);
