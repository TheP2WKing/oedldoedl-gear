...
public class ItemChargedEssence extends ModItemBase {
	public ItemChargedEssence(String modid, String name, CreativeTabs tab, EnumRarity rarity, boolean hasEffect,
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
		...
		if (!worldIn.isRemote) {
			EntityChargedEssence entity = new EntityChargedEssence(worldIn, playerIn);
