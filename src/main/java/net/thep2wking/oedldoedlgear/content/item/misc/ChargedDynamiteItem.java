...
public class ChargedDynamiteItem extends ModItemBase
{
	public ChargedDynamiteItem(Rarity rarity, boolean hasEffect, boolean fireImmunity, int tooltipLines, int annotationLines, Properties properties) 
	{
