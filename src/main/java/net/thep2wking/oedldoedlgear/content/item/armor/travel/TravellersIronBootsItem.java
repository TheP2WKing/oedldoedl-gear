...
public class TravellersIronBootsItem extends ModArmorItemBase
{
	public TravellersIronBootsItem(IArmorMaterial materialIn, EquipmentSlotType slot, Rarity rarity, boolean hasEffect, boolean fireImmunity, int tooltipLines, int annotationLines, Properties properties) 
    {
    ...
    {
    	if (player.inventory.armorInventory.get(0).getItem().equals(ModItems.TRAVELLERS_IRON_BOOTS.get()))
    	{
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) 
    {
		...
		if (ModTooltips.showEffectTip())
		{
			...
			ModTooltips.addPotionEffect(tooltip, Effects.SPEED.getName(), false, 2, 20);
