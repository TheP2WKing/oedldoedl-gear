...
public class ItemExplosionCore extends ModItemBase {
	public ItemExplosionCore(String modid, String name, CreativeTabs tab, EnumRarity rarity, boolean hasEffect,
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
		...
		if (!worldIn.isRemote) {
			EntityExplosionCore entity = new EntityExplosionCore(worldIn, playerIn);
