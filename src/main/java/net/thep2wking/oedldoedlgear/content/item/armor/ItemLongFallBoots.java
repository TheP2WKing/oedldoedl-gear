...
public class ItemLongFallBoots extends ModItemArmorBase {
	public ItemLongFallBoots(String modid, String name, CreativeTabs tab, ArmorMaterial material, int renderIndex,
	...
	public static void onLivingFall(LivingFallEvent event) {
		if (event.getEntity() instanceof EntityPlayer) {
			...
			if (player.inventory.armorInventory.get(0).getItem().equals(ModItems.LONG_FALL_BOOTS)) {
