...
public class UnstableShearsItem extends ModShearsItemBase
{
	public UnstableShearsItem(IItemTier itemTier, Rarity rarity, boolean hasEffect, boolean fireImmunity, int tooltipLines, int annotationLines, Properties properties) 
	{
	...
	{
		return stack.getItem() instanceof UnstableShearsItem;
	}
