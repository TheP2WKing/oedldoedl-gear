...
public class ItemExplosiveSnowball extends ModItemBase {
	public ItemExplosiveSnowball(String modid, String name, CreativeTabs tab, EnumRarity rarity, boolean hasEffect,
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
		...
		if (!worldIn.isRemote) {
			EntityExplosiveSnowball entity = new EntityExplosiveSnowball(worldIn, playerIn);
