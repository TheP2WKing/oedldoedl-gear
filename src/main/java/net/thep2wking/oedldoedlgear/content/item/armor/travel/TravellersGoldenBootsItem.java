...
public class TravellersGoldenBootsItem extends ModArmorItemBase
{
	public TravellersGoldenBootsItem(IArmorMaterial materialIn, EquipmentSlotType slot, Rarity rarity, boolean hasEffect, boolean fireImmunity, int tooltipLines, int annotationLines, Properties properties) 
    {
    ...
    {
    	if (player.inventory.armorInventory.get(0).getItem().equals(ModItems.TRAVELLERS_GOLD_BOOTS.get()))
    	{
	    	player.addPotionEffect(new EffectInstance(Effects.JUMP_BOOST, 10, 2, false, false));
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) 
    {
		...
		if (ModTooltips.showEffectTip())
		{
			...
			ModTooltips.addPotionEffect(tooltip, Effects.JUMP_BOOST.getName(), false, 3, 20);
