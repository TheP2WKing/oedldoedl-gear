...
public class EntityTrollTNTPrimed extends Entity {
    public static final DataParameter<Integer> FUSE = EntityDataManager.<Integer>createKey(EntityTrollTNTPrimed.class,
            DataSerializers.VARINT);
    @Nullable
    private EntityLivingBase tntPlacedBy;
    private int fuse;

    public EntityTrollTNTPrimed(World worldIn) {
        super(worldIn);
        this.fuse = 10;
    ...
    public EntityTrollTNTPrimed(World worldIn, double x, double y, double z, EntityLivingBase igniter) {
        this(worldIn);
