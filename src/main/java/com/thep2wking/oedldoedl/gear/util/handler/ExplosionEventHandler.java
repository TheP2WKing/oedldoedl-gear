...
public class ExplosionEventHandler implements IMessage 
{
    public float x, y, z, s;

    public ExplosionEventHandler() {}

    public ExplosionEventHandler(int x, int y, int z, int s) 
    {
        this.x = x;
        this.y = y;
        this.z = z;
    ...
    public static class ExplosionMessageHandler implements IMessageHandler<ExplosionEventHandler, ExplosionEventHandler> 
    {
        @Override
        public ExplosionEventHandler onMessage(ExplosionEventHandler message, MessageContext context) 
        {
        ...
        private void handleMessageOnServer(ExplosionEventHandler message, MessageContext context) 
        {
        ...
        private void handleMessageOnClient(ExplosionEventHandler message, MessageContext context)
        {
            BlockPos pos = new BlockPos(message.x, message.y, message.z);
