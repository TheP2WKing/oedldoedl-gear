...
public class ItemBaseBoots extends ItemArmor implements IHasModel
{
	public ItemBaseBoots(String name, ArmorMaterial armorMaterial, int renderIndexIn, EntityEquipmentSlot slot)
	{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation)
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.base_boots.tip"),
  			});
  		}
	}
}