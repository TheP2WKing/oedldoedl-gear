...
public class ItemStoneSmashbat extends ItemTool implements IHasModel
{
	private static Set<Block> effectiveBlocks = Sets.newHashSet(Blocks.AIR);

	public ItemStoneSmashbat(String name, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn) 
	{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
			...
			{
				TextFormatting.GREEN+I18n.format("item.oedldoedl.stone_smashbat.tip"),
			});
  		}
	}
}