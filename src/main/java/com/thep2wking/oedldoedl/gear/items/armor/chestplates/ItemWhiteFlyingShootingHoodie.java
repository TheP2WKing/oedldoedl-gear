...
public class ItemWhiteFlyingShootingHoodie extends ItemArmor implements IHasModel
{
	public ItemWhiteFlyingShootingHoodie(String name, ArmorMaterial armorMaterial, int renderIndexIn, EntityEquipmentSlot slot)
	{
		super(ItemInit.ARMOR_MATERIAL_WHITE_FLYING_SHOOTING_HOODIE, renderIndexIn, slot);
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation)
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.white_flying_shooting_hoodie.tip"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.white_flying_shooting_hoodie.tip2"),
  			});
  		}
	}
}