...
public class ItemClassicFlyingShootingHoodie extends ItemArmor implements IHasModel
{
	public ItemClassicFlyingShootingHoodie(String name, ArmorMaterial armorMaterial, int renderIndexIn, EntityEquipmentSlot slot)
	{
		super(ItemInit.ARMOR_MATERIAL_CLASSIC_FLYING_SHOOTING_HOODIE, renderIndexIn, slot);
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation)
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.classic_flying_shooting_hoodie.tip"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.classic_flying_shooting_hoodie.tip2"),
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.classic_flying_shooting_hoodie.tip3"),
  			});
  		}
	}
}