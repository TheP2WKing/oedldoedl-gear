...
public class ItemOedldoedlSmashbat extends ItemTool implements IHasModel
{
	private static Set<Block> effectiveBlocks = Sets.newHashSet(Blocks.AIR);

	public ItemOedldoedlSmashbat(String name, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn) 
	{
    ...
    {
        entity.world.playSound(player, player.getPosition(), SoundInit.SOUND_SMASH_DIAMOND, SoundCategory.MASTER, 10.0f, 1.0f);
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation) 
  		{
			...
			{
				TextFormatting.GREEN+I18n.format("item.oedldoedl.oedldoedl_smashbat.tip"),
			});
  		}
	}
}