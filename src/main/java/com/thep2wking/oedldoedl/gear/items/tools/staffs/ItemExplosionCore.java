...
public class ItemExplosionCore extends Item implements IHasModel
{
	public ItemExplosionCore(String name)
	{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced)
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation)
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.format("item.oedldoedl.explosion_core.tip"),
  			});
  		}
	}
}