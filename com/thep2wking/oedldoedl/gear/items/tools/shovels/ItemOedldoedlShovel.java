package com.thep2wking.oedldoedl.gear.items.tools.shovels;
...
public class ItemOedldoedlShovel extends ItemSpade implements IHasModel
{
	public ItemOedldoedlShovel(String name, ToolMaterial material) 
	{
		...
		if (CoreConst.ITEM_INFORMATION) 
  		{
			...
			{
				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.oedldoedl_shovel.tip"),
			});
  		}
	}
}