package com.thep2wking.oedldoedl.gear.items.tools.hoes;
...
public class ItemOedldoedlHoe extends ItemHoe implements IHasModel
{
	public ItemOedldoedlHoe(String name, ToolMaterial material) 
	{
		...
		if (CoreConst.ITEM_INFORMATION) 
  		{
			...
			{
				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.oedldoedl_hoe.tip"),
			});
  		}
	}
}