package com.thep2wking.oedldoedl.gear.items.tools.swords;
...
public class ItemOedldoedlSword extends ItemSword implements IHasModel
{
	public ItemOedldoedlSword(String name, ToolMaterial material) 
	{
		...
		if (CoreConst.ITEM_INFORMATION) 
  		{
			...
			{
				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.oedldoedl_sword.tip"),
			});
  		}
	}
}