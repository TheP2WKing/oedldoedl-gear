...
{  
    ...
    private void startFlying(EntityPlayer player) 
    {
        ...
        {
      		if (CoreConst.BAUBLE_FLIGHT && CoreConst.BAUBLE_EFFECTS) 
      		{
      			player.func_71016_p();
      		}
        }
	...
	public void func_77624_a(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) 
	{
  		if (CoreConst.ITEM_INFORMATION) 
  		{
  			...
  			{
  				TextFormatting.GREEN+I18n.func_135052_a("item.oedldoedl.gremorium_amulet.tip"),
  			});
  		}
  		
  		if (CoreConst.POTION_INFORMATION && CoreConst.BAUBLE_FLIGHT && CoreConst.BAUBLE_EFFECTS) 
  		{
  			TooltipControlEffectInfo.addTooltipText(tooltip, new String[] 
  			{
  				...
  				TextFormatting.WHITE+""+TextFormatting.ITALIC+I18n.func_135052_a("item.oedldoedl.gremorium_amulet.effects.tip"),
  			});
  		}
	}
}